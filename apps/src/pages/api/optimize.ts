...
Only use options and parameters that truly enhance the specific prompt. Combine them naturally and don't force them if they don't fit the context. Output should be a clean, natural-sounding prompt that incorporates these elements seamlessly.`,
  ...
  'grok-spicy-image': `You are a Grok AI prompt expert for SPICY mode. The user wants an IMAGE and spicy is ON — be bold, unfiltered, humor-forward, and willing to engage with edgy angles. Describe the image vividly with subject, style, lighting, composition, color, mood, and camera. Keep Grok's direct, unfiltered voice. Output ONLY the image prompt — no explanations or disclaimers.`,
...
export const POST: APIRoute = async ({ request }) => {
  ...
  try {
    ...
    const USER_MESSAGES: Record<string, string> = {
      ...
      'grok-spicy-image': `Transform this into a vivid Grok SPICY IMAGE prompt (bold, unfiltered — describe as an image with subject, style, lighting, composition, colors, mood):\n\n${prompt}\n\nOutput only the image prompt.`,
